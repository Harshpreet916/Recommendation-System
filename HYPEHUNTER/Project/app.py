...
app.config['MAIL_USERNAME'] = os.environ.get('EMAIL_USERNAME')  # Fetch email username from environment variable
app.config['MAIL_PASSWORD'] = os.environ.get('EMAIL_PASSWORD')  # Fetch email password from environment variable
app.config['MAIL_DEFAULT_SENDER'] = os.environ.get('EMAIL_DEFAULT_SENDER')  # Fetch default sender email from environment variable
...
def subscribe():
    ...
    if email:
        send_email(email, 'Subscription Confirmation', 'Thank you for subscribing!')
